	...
	public class HandlesExtra
	{
		...
		public class Styles
		{
			...
			public Styles()
			{
				...
				dotCyan.normal.background = GetEditorTexture("dotCyan");
				dotYellow.fixedWidth = 8f;
				dotYellow.fixedHeight = 8f;
				dotYellow.normal.background = GetEditorTexture("dotYellow");

				dotRed.fixedWidth = 8f;
				dotRed.fixedHeight = 8f;
				dotRed.normal.background = GetEditorTexture("dotRed");

				dotBlackBig.fixedWidth = 23.5f;
				dotBlackBig.fixedHeight = 23.5f;
				dotBlackBig.normal.background = GetEditorTexture("dotBlackBig");

				dotYellowBig.fixedWidth = 23.5f;
				dotYellowBig.fixedHeight = 23.5f;
				dotYellowBig.normal.background = GetEditorTexture("dotYellowBig");
			}
		}

        private static Texture2D GetEditorTexture(string name)
        {
            return AssetDatabase.FindAssets(string.Format("{0} t:texture", name))
